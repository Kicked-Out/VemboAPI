...
{
    /// <inheritdoc />
    public partial class UserLessonExerciseProgressMistakeTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UserExerciseMistakes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserExerciseMistakes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserExerciseMistakes_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExerciseMistakes_UserId",

    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUnitProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserUnitProgresses_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUnitProgresses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Difficulty = table.Column<bool>(type: "bit", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLevelProgresses_UserId",
                table: "UserLevelProgresses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUnitProgresses_UnitId",
                table: "UserUnitProgresses",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUnitProgresses_UserId",
                table: "UserUnitProgresses",
                column: "UserId");
        }
